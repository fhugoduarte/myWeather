...
5. Add the key on **.env** file.

6. SignUp in [OpenWeather](https://home.openweathermap.org/users/sign_in) and generate an API key.

7. Add the key on **.env** file.

8. Run the expo project and generate a QrCode.
...
<p align="center">
  <img src="screenshots/screens.png" width="100%"  />
</p>
